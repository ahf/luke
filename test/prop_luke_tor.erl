...
%%% @doc Property Tests for luke_tor
%%% @end
%%% -----------------------------------------------------------
-module(prop_luke_tor).
...
%% @private
keypair() ->
    #{ secret := Secret, public := Public } = luke_tor:keypair(),
    {Public, Secret}.
